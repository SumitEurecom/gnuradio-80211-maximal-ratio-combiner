...
# Title: Wifi Rx
# Generated: Tue Sep 25 12:41:55 2018
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_11_soft_frame_equalizer_1 = ieee802_11.soft_frame_equalizer(ieee802_11.LS, freq, samp_rate, 0, 0, False, False)
        self.ieee802_11_parse_mac_1 = ieee802_11.parse_mac(False, True)
        ...
        self.blocks_null_sink_1_0 = blocks.null_sink(gr.sizeof_float*48)
        self.blocks_null_sink_1 = blocks.null_sink(gr.sizeof_char*48)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/john/t0+25/ifi10msgain0.5bpsk1500b511datasym.pcap', False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_soft_2, 'out'), (self.foo_wireshark_connector_1, 'in'))
        ...
        self.connect((self.ieee802_11_soft_frame_equalizer_1, 1), (self.blocks_null_sink_1_0, 0))
