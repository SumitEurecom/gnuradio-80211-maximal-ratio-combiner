...
# Title: Wifi Loopback
# Generated: Sun Oct 21 22:26:56 2018
##################################################
...
class wifi_loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._snr_range = Range(-15, 30, 0.1, 2, 200)
        ...
        self._pdu_length_range = Range(0, 1500, 1, 1, 200)
        ...
        self._interval_range = Range(10, 1000, 1, 10, 200)
        ...
        self.wifi_phy_hier_soft_0 = wifi_phy_hier(
            bandwidth=20e6,
            chan_est=chan_est,
            encoding=encoding,
            frequency=2.437e9,
        ...
        self._temp_var_range = Range(0, 100, 1, 50, 200)
        self._temp_var_win = RangeWidget(self._temp_var_range, self.set_temp_var, "temp_var", "counter_slider", float)
        self.top_grid_layout.addWidget(self._temp_var_win)
        ...
        self.ieee802_11_mac_0 = ieee802_11.mac(([0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), ([0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), ([0x00, 0x00, 0x00, 0x00, 0x00, 0x00]))
        ...
        self.channels_channel_model_0 = channels.channel_model(
        	noise_voltage=1,
        	frequency_offset=epsilon * 2.437e9 / 20e6,
        	epsilon=1.0,
        	taps=(1.0,0.09),
        	noise_seed=0,
        	block_tags=False
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("".join("1" for i in range(pdu_length))), interval)
        ...
        self.msg_connect((self.ieee802_11_mac_0, 'phy out'), (self.wifi_phy_hier_soft_0, 'mac_in'))
        self.msg_connect((self.ieee802_11_parse_mac_0, 'fer'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))
        self.msg_connect((self.ieee802_11_parse_mac_0, 'tpr'), (self.blocks_pdu_to_tagged_stream_0_1, 'pdus'))
        self.msg_connect((self.wifi_phy_hier_soft_0, 'carrier'), (self.blocks_pdu_to_tagged_stream_0_0, 'pdus'))
        self.msg_connect((self.wifi_phy_hier_soft_0, 'mac_out'), (self.ieee802_11_parse_mac_0, 'in'))
        ...
        self.connect((self.pfb_arb_resampler_xxx_0, 0), (self.wifi_phy_hier_soft_0, 0))
        self.connect((self.wifi_phy_hier_soft_0, 0), (self.foo_packet_pad2_0, 0))
    ...
    def set_temp_var(self, temp_var):
    ...
    def set_pdu_length(self, pdu_length):
        ...
        self.blocks_message_strobe_0.set_msg(pmt.intern("".join("1" for i in range(self.pdu_length))))
    ...
    def set_epsilon(self, epsilon):
        ...
        self.channels_channel_model_0.set_frequency_offset(self.epsilon * 2.437e9 / 20e6)
    ...
    def set_encoding(self, encoding):
        ...
        self._encoding_callback(self.encoding)
        self.wifi_phy_hier_soft_0.set_encoding(self.encoding)
    ...
    def set_chan_est(self, chan_est):
        ...
        self._chan_est_callback(self.chan_est)
        self.wifi_phy_hier_soft_0.set_chan_est(self.chan_est)
