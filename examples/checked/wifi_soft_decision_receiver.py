...
# Title: Wifi Soft Decision Receiver
# Generated: Mon Sep 24 14:42:54 2018
##################################################
...
class wifi_soft_decision_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Soft Decision Receiver")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi Soft Decision Receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "wifi_soft_decision_receiver")
        ...
        self._threshold_line_edit.returnPressed.connect(
        	lambda: self.set_threshold(int(str(self._threshold_line_edit.text().toAscii()))))
        self.top_grid_layout.addWidget(self._threshold_tool_bar)
        ...
        self.qtgui_time_sink_x_0.set_y_label('Noise Level Ratio', "")
        ...
        labels = ['Total Packets Received (With LNV LLR scaling)', '', '', '', '',
                  '', '', '', '', '']
        units = ['', '', '', '', '',
                 '', '', '', '', '']
        ...
        for i in xrange(1):
            ...
            self.qtgui_number_sink_0_0.set_max(i, 100)
        ...
        labels = ['Total Packets Received (Without LNV LLR scaling)', '', '', '', '',
                  '', '', '', '', '']
        units = ['', '', '', '', '',
                 '', '', '', '', '']
        ...
        self.ieee802_11_soft_frame_equalizer_1_0 = ieee802_11.soft_frame_equalizer(ieee802_11.LS, freq, samp_rate, 1, threshold, False, False)
        self.ieee802_11_soft_frame_equalizer_1 = ieee802_11.soft_frame_equalizer(ieee802_11.LS, freq, samp_rate, 0, threshold, False, False)
        self.ieee802_11_parse_mac_1_0 = ieee802_11.parse_mac(False, False)
        self.ieee802_11_parse_mac_1 = ieee802_11.parse_mac(False, False)
        ...
        self.ieee802_11_decode_mac_soft_2_0 = ieee802_11.decode_mac_soft(False, False)
        self.ieee802_11_decode_mac_soft_2 = ieee802_11.decode_mac_soft(False, False)
        self.fft_vxx_0 = fft.fft_vcc(64, True, (window.rectangular(64)), True, 1)
        self._chan_est_options = [ieee802_11.LS_s, ieee802_11.LMS_s, ieee802_11.STA, ieee802_11.COMB]
        ...
        self.blocks_pdu_to_tagged_stream_1_0 = blocks.pdu_to_tagged_stream(blocks.float_t, 'packet_len')
        ...
        self.blocks_null_sink_1_0 = blocks.null_sink(gr.sizeof_char*48)
        self.blocks_null_sink_1 = blocks.null_sink(gr.sizeof_char*48)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_soft_2, 'out'), (self.ieee802_11_parse_mac_1, 'in'))
        self.msg_connect((self.ieee802_11_decode_mac_soft_2_0, 'out'), (self.ieee802_11_parse_mac_1_0, 'in'))
        self.msg_connect((self.ieee802_11_parse_mac_1, 'tpr'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))
        self.msg_connect((self.ieee802_11_parse_mac_1_0, 'tpr'), (self.blocks_pdu_to_tagged_stream_0_0, 'pdus'))
        self.msg_connect((self.ieee802_11_soft_frame_equalizer_1, 'symbols'), (self.blocks_pdu_to_tagged_stream_1, 'pdus'))
        self.msg_connect((self.ieee802_11_soft_frame_equalizer_1_0, 'noise_vec'), (self.blocks_pdu_to_tagged_stream_1_0, 'pdus'))
        ...
        self.connect((self.blocks_pdu_to_tagged_stream_0_0, 0), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.blocks_pdu_to_tagged_stream_1, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.blocks_pdu_to_tagged_stream_1_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.fft_vxx_0, 0), (self.ieee802_11_soft_frame_equalizer_1, 0))
        self.connect((self.fft_vxx_0, 0), (self.ieee802_11_soft_frame_equalizer_1_0, 0))
        ...
        self.connect((self.ieee802_11_soft_frame_equalizer_1, 0), (self.blocks_null_sink_1, 0))
        self.connect((self.ieee802_11_soft_frame_equalizer_1, 1), (self.ieee802_11_decode_mac_soft_2, 0))
        self.connect((self.ieee802_11_soft_frame_equalizer_1_0, 0), (self.blocks_null_sink_1_0, 0))
        self.connect((self.ieee802_11_soft_frame_equalizer_1_0, 1), (self.ieee802_11_decode_mac_soft_2_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ieee802_11_soft_frame_equalizer_1_0.set_bandwidth(self.samp_rate)
        self.ieee802_11_soft_frame_equalizer_1.set_bandwidth(self.samp_rate)
    ...
    def set_freq(self, freq):
        ...
        self._freq_callback(self.freq)
        self.uhd_usrp_source_0.set_center_freq(uhd.tune_request(self.freq, rf_freq = self.freq - self.lo_offset, rf_freq_policy=uhd.tune_request.POLICY_MANUAL), 0)
        self.ieee802_11_soft_frame_equalizer_1_0.set_frequency(self.freq)
        self.ieee802_11_soft_frame_equalizer_1.set_frequency(self.freq)
...
def main(top_block_cls=wifi_soft_decision_receiver, options=None):
