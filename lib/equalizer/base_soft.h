...
public:
	virtual ~base_soft() {}; 
	virtual void equalize_soft(gr_complex *in, int n, gr_complex *symbols, uint8_t *bits, boost::shared_ptr<gr::digital::constellation> mod_soft) = 0; // my own base class method, have to be implemented in the derieved class
