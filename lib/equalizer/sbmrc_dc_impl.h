...
#ifndef INCLUDED_IEEE802_11_SBMRC_IMPL_DC_H
#define INCLUDED_IEEE802_11_SBMRC_IMPL_DC_H

#include <ieee802-11/sbmrc_dc.h>
...
class sbmrc_dc_impl : virtual public sbmrc_dc
{

public:
	sbmrc_dc_impl(Equalizer_sbmrc algo, double freq, double bw, int scaling, int threshold, bool log, bool debug);
	~sbmrc_dc_impl();
...
private:
	...
	bool s_decode_signal_field_dc(float *rx_scaled_llr_b1);

	void deinterleave(uint8_t *rx_bits);
	void s_deinterleave(float *rx_scaled_llr);
	void s_deinterleave_dc(float *rx_scaled_llr_b1);

	equalizer_soft_dc::base_soft_dc *d_equalizer;
...
#endif /* INCLUDED_IEEE802_11_SBMRC_IMPL_DC_H */
