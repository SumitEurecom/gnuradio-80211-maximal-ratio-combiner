...
#ifndef INCLUDED_IEEE802_11_SOFT_FRAME_EQUALIZER_IMPL_DC_H
#define INCLUDED_IEEE802_11_SOFT_FRAME_EQUALIZER_IMPL_DC_H
...
class soft_frame_equalizer_impl_dc : virtual public soft_frame_equalizer_dc
{

public:
	soft_frame_equalizer_impl_dc(Equalizer_soft_dc algo, double freq, double bw, int scaling, int threshold, bool log, bool debug);
	~soft_frame_equalizer_impl_dc();

	void set_algorithm(Equalizer_soft_dc algo);
...
private:
	...
	bool s_decode_signal_field_dc(float *rx_scaled_llr_b1, float *rx_scaled_llr_b2);

	void deinterleave(uint8_t *rx_bits);
	void s_deinterleave(float *rx_scaled_llr);
	void s_deinterleave_dc(float *rx_scaled_llr_b1, float *rx_scaled_llr_b2);
...
#endif /* INCLUDED_IEEE802_11_SOFT_FRAME_EQUALIZER_IMPL_DC_H */
